<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.octest.forms.Employe"%>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
%>
   	<div class="container-fluid  bg" id='bg'>
		<div class="row">
			<div class="menu-bar">
    	<ul>
    		<% 	out.println("<li><a href='traitement1.jsp?log="+e.getLogin()+"' target='zone1'>Acceuil</a></li>");%>
    	<% 	out.println("<li><a href='consultationNote.jsp?login="+e.getLogin()+"&nom="+e.nom+"&dep="+e.getDepartement()+"' target='zone1'>Consultation</a></li>");%>
    		</ul>
			...
			<br>
             ...
             <div class="menu-vertical" style="margin-top:48px;">
             	...
             	<h3>Bienvenue</h3>
             	<div class="menu"><p><%out.println(e.nom); %></p></div>
             	<div class="menu"><p><%out.println(e.getDepartement()); %></p></div>
               </div>
	 ...
	 <div class="col-sm-9 col-sm-offset-0 col-md-10 col-md-offset-1 main ">
       ...
       <% out.println("<iframe src='traitement1.jsp?log="+e.getLogin()+"'   name='zone1' style='width: 109.5%; height: 93.5vh; border: none;'>");%>
         </iframe>
       </frame>
